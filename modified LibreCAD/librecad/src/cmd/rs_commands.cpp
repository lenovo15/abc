...
RS_Commands::RS_Commands() {
    ...
    cmdTranslation.insert("stairs", tr("stairs"));
    mainCommands.insert(tr("stairs"), RS2::ActionDrawStairs);
    cmdTranslation.insert("st", tr("st"));
    shortCommands.insert(tr("st"), RS2::ActionDrawStairs);
