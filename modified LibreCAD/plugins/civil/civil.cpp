/*****************************************************************************/
/*  civil.cpp - plugin example for LibreCAD                                 */
/*                                                                           */
...
void lc_Sampledlg::readSettings()
 {
    QString str;
    QSettings settings(QSettings::IniFormat, QSettings::UserScope, "LibreCAD", "civil_plugin");
...
Q_EXPORT_PLUGIN2(lc_civil, LC_Sample);
#endif
